        ...
        while (
            ...
            if self.step % self.save_interval == 0:
                ...
                if self.step != 0:
                    ...
                    #arr=torch.unbind(arr, dim=0)
                    
                    normalized_images = torch.stack([transform(image.detach().cpu().numpy()) for image in torch.unbind(arr, dim=0)])
                    
                    fid_sample_array = normalized_images
